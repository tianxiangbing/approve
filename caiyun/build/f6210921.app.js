			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'a',
							{ className: 'focus', onClick: this.Tab.bind(this, 0), __self: this
							},
							'待审批'
						),
						_react2.default.createElement(
							'a',
							{ onClick: this.Tab.bind(this, 1), __self: this
							},
							'已审批'
						)
					),
					_react2.default.createElement(
						...
						this.state.list.map(function (item) {
							return _react2.default.createElement(_ListItem2.default, { avatar: _this2.renderAvatar(item), title: '标题xxxx ', desc: '这是描述啊', time: '昨天', status: '1', __self: _this2
							});
						}),
