			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.detail.map(function (item, index) {
						var indx = index + 1;
						return _react2.default.createElement(_CaigouDetail2.default, { detail: _this4.state.detail, ref: "caigouDetail" + index, index: indx, computeMoney: _this4.computeMoney.bind(_this4), item: item, key: item.key, del: _this4.del.bind(_this4, index) });
					}),
					_react2.default.createElement(
						'div',
