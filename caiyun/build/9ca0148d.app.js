		...
		_createClass(Create, [{
			...
			value: function componentWillMount() {
				...
				_config2.default.ajax('lastSelected', {
					...
					var data = { "status": 200, "total": 0, "result": { "isSet": 0, "flowInfos": [{ "uid": 292177, "uname": "青城名字要很长很长才好青城名字要很长很长", "mobile": null, "avatar": "http://n1.store.uban360.com:7188/sfs/avatar?uid=292177" }] }, "msg": null };
				...
				_config2.default.ajax('getFlowByType', {
					...
					var data = { "status": 200, "total": 0, "result": { "isSet": 1, "flowInfos": [{ "uid": 292177, "uname": "青城名字要很长很长才好青城名字要很长很长", "mobile": null, "avatar": "http://n1.store.uban360.com:7188/sfs/avatar?uid=292177" }] }, "msg": null };
					var arr = (data.result.flowInfos || []).map(function (item) {
						return { name: item.uname, uid: item.uid };
					});
							...
							this.state.imgList.map(function (item, index) {
								...
								return _react2.default.createElement(
									...
									!item.uploaded ? _react2.default.createElement(
										...
										{ className: 'uploading' },
										'上传中...'
									) : _react2.default.createElement('i', { onClick: _this7.del.bind(_this7, item, index), className: 'del iconfont icon-103' }),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'span',
								null,
								this.state.isSet ? "(管理员已设置审批人)" : undefined
							)
						),
						_react2.default.createElement(
							'div',
							...
							this.state.authList.map(function (item, index) {
								return _react2.default.createElement(
									...
									_react2.default.createElement(
										'div',
										{ className: 'item', key: index, onClick: _this7.delPeople.bind(_this7, index) },
										_this7.formatImg(item),
										!item.error ? _react2.default.createElement('img', { onError: _this7.errorImg.bind(_this7, item), src: "http://n1.store.uban360.com:7188/sfs/avatar?uid=" + item.uid }) : undefined,
										_react2.default.createElement(
											'div',
											{ className: 'userName' },
											item.name
									...
									_this7.state.isSet && index == _this7.state.authList.length - 1 ? undefined : _react2.default.createElement('i', { className: 'iconfont icon-shenpiliucheng' })
								);
							}),
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							this.state.informList.map(function (item, index) {
								return _react2.default.createElement(
									'div',
									{ className: 'item', key: index, onClick: _this7.delPeople2.bind(_this7, index) },
									_this7.formatImg(item),
									!item.error ? _react2.default.createElement('img', { onError: _this7.errorImg.bind(_this7, item), src: "http://n1.store.uban360.com:7188/sfs/avatar?uid=" + item.uid }) : undefined,
									_react2.default.createElement(
										'div',
