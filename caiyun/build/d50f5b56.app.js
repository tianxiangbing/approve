	  	...
	  	this.setState({detail:this.state.detail});
			...
			value: function setTime() {
				...
				_config2.default.native('setTime').then(function (res) {
					_this5.setState({ expectPayDate: res.data });
				});
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.detail.map(function (item, index) {
						var indx = index + 1;
						return _react2.default.createElement(_CaigouDetail2.default, { detail: _this6.state.detail, ref: "caigouDetail" + index, index: indx, computeMoney: _this6.computeMoney.bind(_this6), item: item, key: item.key, del: _this6.del.bind(_this6, index) });
					}),
					_react2.default.createElement(
						'div',
	  	...
	  	this.setState({detail:this.state.detail});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.state.detail.map(function (item, index) {
						var indx = index + 1;
						return _react2.default.createElement(_ExpenseDetail2.default, { detail: _this4.state.detail, ref: "caigouDetail" + index, index: indx, computeMoney: _this4.computeMoney.bind(_this4), item: item, key: item.key, del: _this4.del.bind(_this4, index) });
					}),
					_react2.default.createElement(
						'div',
						{ className: 'row add-row', onClick: this.AddRow.bind(this) },
