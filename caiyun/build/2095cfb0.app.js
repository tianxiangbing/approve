		...
		_createClass(UserAvatar, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					this.formatImg(this.props.item),
					!this.props.item.error ? _react2.default.createElement('img', { onError: this.errorImg.bind(this, this.props.item), src: "http://n1.store.uban360.com:7188/sfs/avatar?uid=" + this.props.item.uid, __self: this
					}) : undefined,
					_react2.default.createElement(
						'div',
						{ className: 'userName', __self: this
						},
