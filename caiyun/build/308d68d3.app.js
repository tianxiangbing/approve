	...
	var Create = function (_Component) {
		...
		_createClass(Create, [{
			...
			value: function componentWillMount() {
				...
				_config2.default.ajax('lastSelected').then(function (res) {
					...
					_this3.setState({ informList: data.result.flowInfos });
				});
				_config2.default.ajax('getFlowByType').then(function (res) {
					var data = { "status": 200, "total": 0, "result": { "isSet": 0, "flowInfos": [{ "uid": 292177, "uname": "青城名字要很长很长才好青城名字要很长很长", "mobile": null, "avatar": "http://n1.store.uban360.com:7188/sfs/avatar?uid=292177" }] }, "msg": null };
					_this3.setState({ authList: data.result.flowInfos });
				});
			}
		}, {
			key: 'componentDidMount',
